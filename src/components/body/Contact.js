...
export class Contact extends Component {
    ...
    handleInputChange = event =>{
        const value = event.target.type ==='ckeckbox' ? event.target.checked: event.target.value;
                    ...
                    <div className="col-12 col-md-7">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" name="massage" value={this.state.massage} rows="12" onChange={this.handleInputChange}></Input>
                                </Col>
                            </FormGroup>
                            <FormGroup>
